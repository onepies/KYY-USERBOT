...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("`HAI,CINTA KITA`")
    sleep(1)
    await typew.edit("`SEPERTI!`")
    sleep(1)
    await typew.edit("`KOTA BOGOR!`")
    sleep(1)
    await typew.edit("`UDAH INDAH,SEJUK NYAMAN!`")
    sleep(1)
    ...
    sleep(1)
    await typew.edit("`I HEART YOUUUU💘💓`")
    sleep(1)
